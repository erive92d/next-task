        ...
        <div className='flex flex-col justify-center items-center h-96'>
            <form onSubmit={handleSubmit} className='bg-white p-4 rounded w-96 h-96 flex flex-col gap-4'>
                <div className='flex flex-col'>
                    ...
                    <input maxLength={20} name="title" onChange={handleChange} value={task.title} className='input input-ghost px-2 input-bordered bg-white' type="text" />
                </div>
                <div className='flex flex-col'>
                    <label htmlFor='description'>Description</label>
                    <textarea maxLength={100} name="description" onChange={handleChange} value={task.description} className='textarea px-2 textarea-lg text-sm textarea-bordered bg-white' />
                </div>
                <div className='flex flex-col'>
